...
class AlgorithmHandler:
    ...
    def __init__(self):
        show_algo_display = bool(config['algo_display']['show_display'])
    ...
    def plot_lines(self, lines_by_origin_outpatient: dict):
        line_color = config['algo_display']['line_color']
        show_line = bool(config['algo_display']['show_line'])
        line_transparency = float(config['algo_display']['line_transparency'])
        immediately_remove_line = bool(config['algo_display']['immediately_remove_line'])
    ...
    def plot_points(self, point_coords):
        ...
        show_scatter = bool(config['algo_display']['show_scatter'])
        scatter_transparency = float(config['algo_display']['scatter_transparency'])
        immediately_remove_scatter = bool(config['algo_display']['immediately_remove_scatter'])
    ...
    def _lookup_poly_characteristics(self, poly_type: str):
        poly_type_data = {
            'search_area': {
                ...
                'immediately_remove': config['algo_display']['immediately_remove_search_area'],
                'should_plot': False,
